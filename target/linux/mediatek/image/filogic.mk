...
define Device/melonpi_m81-pro
  ...
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-phy-airoha-en8811h airoha-en8811h-firmware \
  kmod-hwmon-pwmfan kmod-usb3 kmod-usb-storage kmod-usb-serial-option kmod-usb-net-qmi-wwan uqmi kmod-usb-net-cdc-ether
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_IN_UBI := 1
